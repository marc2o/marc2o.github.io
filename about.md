...
- **[{{repository.name}}]({{repository.html_url}})** {{repository.tagline}} {% if repository.language  and repository.language != "" and repository.language ≠ nil %}({{repository.language}}){% endif %}
{% endfor %}
